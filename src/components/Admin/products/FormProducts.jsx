        ...
        <div className="m-10">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
                <div className="mb-4 flex items-center">
                    ...
                    <input type="text" name="name" value={value.name} onChange={handleChange} placeholder="Nombre" maxLength={30} className={`border-2 ${!validation.name ? 'border-red-500' : 'border-gray-300'} p-2 rounded-md focus:outline-none focus:border-blue-500 flex-grow`} />
                ...
                <div className="mb-4 flex items-center">
                    ...
                    <input type="number" name="price" value={value.price} onChange={handleChange} placeholder="Precio" maxLength={3} className={`border-2 ${!validation.name ? 'border-red-500' : 'border-gray-300'} p-2 rounded-md focus:outline-none focus:border-blue-500 flex-grow`} />
                    {!validation.name && <p className="text-red-500 text-xs italic">Este campo es obligatorio.</p>}
                </div>
                <div className="mb-4 flex items-center">
                ...
                <div className="mb-4 flex items-center">
                    ...
                    <input type="text" name="description" value={value.description} onChange={handleChange} placeholder="Descripción" maxLength={50} className={`border-2 ${!validation.name ? 'border-red-500' : 'border-gray-300'} p-2 rounded-md focus:outline-none focus:border-blue-500 flex-grow`} />
                    {!validation.name && <p className="text-red-500 text-xs italic">Este campo es obligatorio.</p>}
                </div>
