        ...
        <div className="container px-6 py-3 mx-auto md:flex md:justify-between md:items-center">
          ...
          <div className={`items-center ${isOpen ? 'flex' : 'hidden'} md:flex`}>
            <div className="flex flex-col mt-2 space-y-1 md:flex-row md:mt-0 md:space-x-8 md:space-y-0">
              ...
              <Link to={'/invoices'} className="text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 transition duration-300 ease-in-out transform  hover:scale-110 ">Facturación</Link>
              <Link to={'/invoices/tableInvoices'} className="text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 transition duration-300 ease-in-out transform  hover:scale-110">Facturas creadas</Link>
